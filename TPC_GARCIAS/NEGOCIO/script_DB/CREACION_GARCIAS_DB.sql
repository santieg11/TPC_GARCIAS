...
BEGIN
	BEGIN TRY
		BEGIN TRANSACTION
			...
			SELECT @CANTIDAD = CANTIDAD, @IDINSUMO = INSUMO FROM INSERTED
			
			UPDATE STOCK SET CANTIDAD = CANTIDAD + @CANTIDAD WHERE IDMATERIAL = @IDINSUMO
			UPDATE INSUMOS SET FECHA_ULT_COMPRA = GETDATE(), ULT_MOD = GETDATE() WHERE IDINSUMO = @IDINSUMO
...
GO
    INSERT INTO INSUMOS (DESCRIPCION,VALOR,FECHA_ULT_COMPRA,FECHA_ALTA,FECHA_BAJA,ULT_MOD,[STATUS]) VALUES ('PERFIL 3/4',450,'1/7/2018','6/10/2018',NULL,'6/10/2018',1)
    INSERT INTO INSUMOS (DESCRIPCION,VALOR,FECHA_ULT_COMPRA,FECHA_ALTA,FECHA_BAJA,ULT_MOD,[STATUS]) VALUES ('SELLADOR',250,'8/9/2018','6/10/2018',NULL,'6/10/2018',1)
GO
    INSERT INTO COMPRAS (CODPROV,FECHA_COMPRA,VALOR_COMPRA,NRODOCUMENTO) VALUES (1,'10/9/2018',900,'0001R00007789')
    INSERT INTO COMPRAS (CODPROV,FECHA_COMPRA,VALOR_COMPRA,NRODOCUMENTO) VALUES (2,'10/9/2018',500,'0001R00001245')
    INSERT INTO COMPRAS (CODPROV,FECHA_COMPRA,VALOR_COMPRA,NRODOCUMENTO) VALUES (1,'20/9/2018',1800,'0001R00007837')
    INSERT INTO COMPRAS (CODPROV,FECHA_COMPRA,VALOR_COMPRA,NRODOCUMENTO) VALUES (2,'20/9/2018',750,'0001R00001378')
GO
    INSERT INTO DETALLE_COMPRAS (NROREMITO,FECHAREMITO,IDCOMPRA,INSUMO,CANTIDAD) VALUES ('0001R00007789','14/9/2018',1,5000,10)
    INSERT INTO DETALLE_COMPRAS (NROREMITO,FECHAREMITO,IDCOMPRA,INSUMO,CANTIDAD) VALUES ('0001R00001245','10/9/2018',2,5001,20)
    INSERT INTO DETALLE_COMPRAS (NROREMITO,FECHAREMITO,IDCOMPRA,INSUMO,CANTIDAD) VALUES ('0001R00007837','25/9/2018',3,5000,20)
    INSERT INTO DETALLE_COMPRAS (NROREMITO,FECHAREMITO,IDCOMPRA,INSUMO,CANTIDAD) VALUES ('0001R00001378','21/9/2018',1,5001,15) 
GO
...
GO
    INSERT INTO VENTAS (FECHA_VTA,IDCLIENTE, VALOR) VALUES ('19/11/2018',1,18000)
    INSERT INTO VENTAS (FECHA_VTA,IDCLIENTE, VALOR) VALUES ('19/11/2018',2,15000)
GO
...
GO
	INSERT INTO USUARIOS(NOMBRE,PW) VALUES ('TEST','TEST')
	INSERT INTO USUARIOS(NOMBRE,PW) VALUES ('VENTAS','VENTAS')